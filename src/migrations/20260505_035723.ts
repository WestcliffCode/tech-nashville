...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_hero_text_backdrop" AS ENUM('none', 'frosted', 'dark');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_text_backdrop" AS ENUM('none', 'frosted', 'dark');
  ...
  CREATE TABLE "pages" (
  	...
  	"hero_text_backdrop" "enum_pages_hero_text_backdrop" DEFAULT 'none',
  	"meta_title" varchar,
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_hero_text_backdrop" "enum__pages_v_version_hero_text_backdrop" DEFAULT 'none',
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_hero_text_backdrop";
  ...
  DROP TYPE "public"."enum__pages_v_version_hero_text_backdrop";
